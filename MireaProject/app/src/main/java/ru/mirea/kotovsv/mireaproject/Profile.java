...
//        setContentView(binding.getRoot());
        ...
        SharedPreferences sharedPref = requireContext().getSharedPreferences("profileInfo", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor	= sharedPref.edit();

        sendButton.setOnClickListener( view -> {
                editor.putString("GROUP", binding.inputGroup.getText().toString());
