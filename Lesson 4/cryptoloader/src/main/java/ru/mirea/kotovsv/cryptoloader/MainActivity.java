...
import ru.mirea.kotovsv.cryptoloader.databinding.ActivityMainBinding;
...
//    public void	onClickButton()	{
            ...
            byte[] encryptedText = encryptMsg(binding.editTextText.getText().toString(), secretKey);
    ...
    public	static SecretKey generateKey(){
        try	{
            ...
            sr.setSeed("UNDERTALE by TobyFox".getBytes());
